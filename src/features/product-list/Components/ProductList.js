            ...
            <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
              ...
              <div className="flex items-center">
                <Menu as="div" className="relative inline-block text-left ">
                  ...
                  >
                    {/* // sorting items */}
                    <Menu.Items className="absolute right-0 z-10 mt-2 w-40 origin-top-right rounded-md bg-white shadow-2xl ring-1 ring-black ring-opacity-5 focus:outline-none p-5 text-wrap">
                      <div className="py-1 text-wrap flex flex-col">
                            ...
                            {({ active }) => (
                              <a
                                ...
                                className={classNames(
                                  option.current
                                    ? "font-medium text-gray-900 w-max cursor-pointer"
                                    : "text-gray-500 w-max cursor-pointer",
                                  active
                                    ? "bg-gray-100 w-max cursor-pointer"
