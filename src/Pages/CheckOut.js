    ...
    <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
        <div className="lg:col-span-3">
          <form className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 bg-white mt-16 mb-10">
      ...
      {addresses.map((address) => (
        <li key={address.email} className="flex justify-between gap-x-6 py-5">
          ...
          <input
                    ...
                    name="payments"
                    type="radio"
                    className="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600 mt-2"
                  />
          ...
          <div className="hidden shrink-0 sm:flex sm:flex-col sm:items-end">
           <p className="text-sm leading-6 text-gray-900">{address.phone}</p>
            ...
            <p className="text-sm leading-6 text-gray-900">{address.postCode}</p>
        ...
        <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 bg-white lg:col-span-2">
